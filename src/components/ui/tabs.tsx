...
export const TabsList = ({
  ...
  // `...props` matters: callers tag the scroller with data-* hooks (e.g.
  // the admin chip strip uses [data-admin-tabs] to auto-centre the active
  // chip). Dropping unknown props silently broke that lookup.
  <div
    role="tablist"
...
export const TabsTrigger = ({
  ...
  return (
    <button
      ...
      onClick={(e) => { onClick?.(e); context.setActiveTab(value); }}
