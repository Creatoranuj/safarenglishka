        ...
        {composerOpen ? (
          ...
          <div className="px-4 py-3">
            <button
              ...
              onClick={() => setComposerOpen(true)}
              disabled={chatBusy}
              className="w-full h-12 rounded-full font-semibold text-sm text-background bg-foreground hover:bg-foreground/90 active:scale-[0.99] transition-all disabled:opacity-60 inline-flex items-center justify-center gap-2"
            >
