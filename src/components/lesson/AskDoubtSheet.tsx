        ...
        {threads.length === 0 && !chatBusy && (
          <div className="flex flex-col items-center text-center px-4 pt-3 pb-2">
            <div className="relative mb-2">
              <div className="relative h-10 w-10 rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/20 flex items-center justify-center shadow-sm">
            ...
            <button
              ...
              className="mt-2.5 inline-flex items-center gap-1.5 px-4 min-h-10 rounded-full bg-gradient-to-r from-primary to-primary/80 text-primary-foreground font-semibold text-xs shadow-md hover:shadow-lg transition-shadow"
            >
              ...
              <div className="flex flex-wrap justify-center gap-1">
                {suggestions.slice(0, 4).map((s) => (
                  <button
                    ...
                    className="text-[10px] px-2.5 py-1 rounded-full border border-border bg-accent/40 hover:bg-accent/70 text-foreground transition-colors"
                  >
                    {s}
                  </button>
                ))}
