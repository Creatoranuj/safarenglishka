    ...
    >
      <div className="flex items-center gap-2">
        <Button
          ...
          className="text-foreground hover:bg-muted h-8 w-8 active:scale-95 transition-transform duration-150 ease-out"
      ...
      <div className="flex items-center gap-2">
        ...
        {isAuthenticated ? (
          <Link to="/profile" onClick={() => { void selectionHaptic(); }}>
            <Button variant="ghost" size="icon" className="text-foreground hover:bg-muted relative active:scale-95 transition-transform duration-150" aria-label="Profile">
              <ProfileAvatar
