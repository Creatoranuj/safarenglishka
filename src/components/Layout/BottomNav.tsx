...
const studentTabs = [
  { path: "/dashboard", label: "Home", iconSrc: homeIcon, id: "bottom-nav-home" },
  { path: "/courses", label: "Courses", iconSrc: scienceIcon, id: "bottom-nav-courses" },
  { path: "/my-courses", label: "My Courses", iconSrc: studentIcon, id: "bottom-nav-my-courses" },
];
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-card border-t border-border z-30 md:hidden safe-area-bottom nb-hide-on-kb">
      <div className="flex items-center justify-around h-16 px-1">
        {studentTabs.map(({ path, label, iconSrc, id }) => {
