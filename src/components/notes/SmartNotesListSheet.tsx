            ...
            <ul className="space-y-2">
              {notes.map((n) => {
                ...
                return (
                  <li
                    key={n.id}
                    className="group flex items-center gap-2 rounded-xl border bg-card px-3 py-2.5 transition-colors [@media(hover:hover)]:hover:bg-accent/40"
                  >
                    <button
                      type="button"
                    ...
                    {!isEditing && (
                      <div className="flex shrink-0 items-center gap-0.5">
                        ...
                        <Button
                          size="icon"
                          variant="ghost"
                          className="h-8 w-8 text-destructive [@media(hover:hover)]:hover:text-destructive"
