...
import { Mail, Phone, Send, Youtube, Shield } from "lucide-react";
      ...
      <div className="container mx-auto max-w-7xl px-6 lg:px-10 py-16 md:py-20">
        <div className="grid lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a href="https://t.me/safarenglishka" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors" aria-label="Telegram — Safar English ka">
                <Send className="h-4 w-4" />
              </a>
              <a href="https://youtube.com/@safarenglishka" target="_blank" rel="noopener noreferrer" className="p-2 rounded-full bg-white/5 hover:bg-white/10 transition-colors" aria-label="YouTube — Safar English ka">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-sm">
          <div className="flex flex-wrap items-center gap-6">
            <a href="mailto:info@safarenglish.com" className="flex items-center gap-2 text-secondary-foreground/60 hover:text-secondary-foreground transition-colors">
              <Mail className="h-4 w-4" />
              info@safarenglish.com
            </a>
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto max-w-7xl px-6 lg:px-10 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-secondary-foreground/40">
            © {currentYear} Safar English. All rights reserved.
          </p>
          <p className="text-xs text-secondary-foreground/40">
