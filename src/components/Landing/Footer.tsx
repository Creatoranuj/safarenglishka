...
import messengerIcon from "../../assets/social/messenger-green.webp";
import broadcastIcon from "../../assets/social/broadcast-blue.webp";
import videosIcon from "../../assets/social/videos-red.webp";
      ...
      <div className="relative container mx-auto max-w-7xl px-6 lg:px-10 py-16 md:py-20">
              ...
              {[
                {
                  ...
                  label: "Chat on Safar Messenger",
                  icon: messengerIcon,
                },
                {
                  href: "https://t.me/safarenglishka",
                  label: "Join Safar Broadcast",
                  icon: broadcastIcon,
                },
                {
                  href: "https://youtube.com/@safarenglishka",
                  label: "Watch Safar Videos",
                  icon: videosIcon,
                },
              ].map((s) => (
                <a
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-sm">
          <div className="flex flex-wrap items-center gap-6">
            <a
              href="mailto:info@safarenglish.com"
