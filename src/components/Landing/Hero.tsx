        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-7">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2 animate-fade-in-up [animation-delay:0.32s]">
              <Link to="/signup">
                <Button size="lg" className="h-12 px-7 rounded-xl text-base font-semibold gap-2 w-full sm:w-auto shadow-md shadow-primary/20">
              ...
              <Link to="/courses">
                <Button
                  size="lg"
                  variant="outline"
                  className="h-12 px-7 rounded-xl text-base font-semibold border-foreground/15 w-full sm:w-auto active:scale-[.98] transition-transform duration-150"
                >
                  Courses dekhein
                </Button>
              </Link>
