...
const HeroIllustration = memo(() => (
  ...
  >
    <div className="relative w-full aspect-[5/4] select-none">
      ...
      <div className="absolute top-0 right-0 w-[58%] aspect-square animate-fade-in-up [animation-delay:0.1s]">
        <div
      ...
      {/* -------- Chat bubble — "kaise seekhun?" (top-left, near Raj) -------- */}
      <button
        type="button"
        onClick={scrollToCourses}
        className="absolute top-[6%] left-0 max-w-[46%] text-left
                   rounded-2xl rounded-bl-sm bg-background border border-border
                   px-3 py-2 shadow-md backdrop-blur-sm
      ...
      {/* -------- Chat bubble — "Safar English ke saath..." (bottom-right, near girl) -------- */}
      <button
        type="button"
        onClick={scrollToCourses}
        className="absolute bottom-[8%] right-0 max-w-[46%] text-left
