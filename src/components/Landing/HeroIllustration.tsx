  ...
  >
    <div className="relative w-full aspect-[5/4] select-none">
      ...
      <div className="absolute top-0 right-0 w-[54%] aspect-square animate-fade-in-up [animation-delay:0.1s]">
        ...
        >
          <img
            ...
            loading="eager"
            decoding="async"
            // React 18 does not map the camelCase form onto the DOM attribute
            // (it warns and drops it) — the lowercase attribute is the one the
            // browser's priority hint actually reads.
            {...{ fetchpriority: "high" }}
        ...
        {/* floating paper-plane badge — bottom-right of girl → Telegram channel */}
        <a
          href="https://t.me/safarenglishka"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Safar English on Telegram"
      ...
      <div className="absolute bottom-0 left-[4%] w-[44%] aspect-square animate-fade-in-up [animation-delay:0.2s]">
        ...
        {/* floating play badge — top-left of Raj → YouTube channel */}
        <a
          href="https://youtube.com/@safarenglishka"
          target="_blank"
          rel="noopener noreferrer"
          aria-label="Safar English on YouTube"
          onClick={() => void selectionHaptic()}
