...
import logoIcon from "../../assets/sarthi-avatar.webp"; // Sarthi guru avatar (in-chat)
import nbLogo from "../../assets/branding/nb-fist-logo.webp"; // NB brand logo (chat header)
import fabLogo from "../../assets/branding/safar-english-icon.webp"; // Safar English brand mark (FAB)
          ...
          <div className="safe-area-top bg-background border-b border-border shrink-0">
            <div className="flex items-center gap-3 px-4 py-3">
              <div className="w-9 h-9 rounded-full overflow-hidden ring-1 ring-border bg-muted shrink-0 flex items-center justify-center">
                <img src={fabLogo} className="w-7 h-7 object-contain" alt="Safar English" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="font-semibold text-base text-foreground leading-tight truncate">Safar English Agent</p>
