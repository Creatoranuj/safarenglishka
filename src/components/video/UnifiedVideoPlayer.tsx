...
const UnifiedVideoPlayer = ({
  ...
  if (platform === "archive") {
    ...
    return (
      <div className="relative aspect-video w-full bg-player-surface rounded-xl overflow-hidden" ref={containerRef}>
  ...
  if (platform === "direct") {
    return (
      <div className="relative aspect-video w-full bg-player-surface rounded-xl overflow-hidden">
        <video
  ...
  return (
    <div className="relative aspect-video w-full bg-player-surface rounded-xl overflow-hidden flex items-center justify-center">
      <p className="text-player-on-surface/50">Unsupported format</p>
    </div>
  );
};
