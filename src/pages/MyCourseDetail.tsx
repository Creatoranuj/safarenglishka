        ...
        <main className="flex-1 overflow-y-auto min-w-0 bg-background pb-[calc(env(safe-area-inset-bottom)+88px)] md:pb-0">
          ...
          >
            <div className="flex items-center gap-2 px-4 py-2">
              {/* Breadcrumbs hidden on mobile per design; keep on md+ */}
              ...
              {/* Mobile: compact back button in place of breadcrumbs */}
              <button
                onClick={() => { if (!closeOneLevel()) navigate("/my-courses"); }}
                className="md:hidden inline-flex items-center justify-center h-11 w-11 -ml-2 rounded-lg text-foreground hover:bg-muted transition-colors"
                aria-label="Go back"
              >
