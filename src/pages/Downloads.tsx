    ...
    <div className="min-h-dvh bg-background">
      ...
      <header className="bg-card border-b min-h-[52px] flex items-center px-4 sticky top-0 z-30 shadow-sm gap-3 safe-area-top">
        ...
        <div className="flex items-center gap-2 flex-1">
          ...
          <h1 className="font-bold text-foreground text-base">{t("page.downloads")}</h1>
          {downloads.length > 0 && (
            ...
            {!loading && filtered.length > 0 && (
              <div className={`space-y-2 ${selectMode ? "pb-24" : ""}`}>
                {filtered.map((item) => {
                  ...
                  <div
                    key={item.id}
                    className={`flex items-center gap-3 p-3 rounded-xl border bg-card [@media(hover:hover)]:hover:bg-accent/5 transition-colors group ${
                    ...
                    {!selectMode && (
                      <div className="flex items-center gap-1 flex-shrink-0">
                        <Button
                          variant="ghost"
                          size="sm"
                          className="h-8 px-2 text-primary [@media(hover:hover)]:hover:bg-primary/10 text-xs"
                        ...
                        <Button
                          variant="ghost"
                          size="icon"
                          className="h-8 w-8 text-primary [@media(hover:hover)]:hover:bg-primary/10"
                        ...
                        <AlertDialog>
                          <AlertDialogTrigger asChild>
                            <Button
                              variant="ghost"
                              size="icon"
                              className="h-8 w-8 text-muted-foreground [@media(hover:hover)]:hover:text-destructive [@media(hover:hover)]:hover:bg-destructive/10"
                            >
                          ...
                          <AlertDialogContent>
                            ...
                            <AlertDialogFooter>
                              ...
                              <AlertDialogAction
                                className="bg-destructive [@media(hover:hover)]:hover:bg-destructive/90 text-destructive-foreground"
