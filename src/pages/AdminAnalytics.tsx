...
const InstallsSection = lazyWithRetry(() => import("../components/admin/analytics/InstallsSection"));
...
const AdminAnalytics = () => {
  ...
  const [tab, setTab] = useState<"learning" | "users" | "payments" | "installs">("learning");
        ...
        <main className="flex-1 p-4 md:p-6 space-y-6">
          ...
          <Tabs value={tab} onValueChange={(v) => setTab(v as any)}>
            <TabsList className="flex-wrap h-auto">
              ...
              <TabsTrigger value="installs">App & Installs</TabsTrigger>
            </TabsList>
              ...
              <CardContent className="p-0">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody>
                      {quizData.map((q, i) => (
                        <tr key={i} className="border-b border-border last:border-0 [@media(hover:hover)]:hover:bg-muted/20 transition-colors">
