...
import checkmarkIcon from "../assets/icons/checkmark-3d.webp";
import doubtsIcon from "../assets/icons/doubts-3d.webp";
import libraryIcon from "../assets/icons/library-3d.webp";
import bellIcon from "../assets/icons/bell-3d.webp";
  ...
  if (loading || authLoading) {
    return (
      <div className="min-h-dvh flex flex-col items-center justify-center bg-background">
        ...
        <p className="mt-4 text-muted-foreground font-medium">Ek pal ruko…</p>
      </div>
    );
  }
