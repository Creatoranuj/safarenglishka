...
const CourseCard = memo(({ course, onNavigate, onDelete }: {
  ...
  <Card
    ref={cardRef}
    className={cn(
      "overflow-hidden rounded-2xl border border-border/70 bg-card shadow-sm [@media(hover:hover)]:hover:shadow-xl active:scale-[0.99] transition-all duration-300 cursor-pointer group relative",
  ...
  >
    ...
    >
      <SmartImage
        ...
        fallbackSrc={coursePlaceholder}
            className="w-full h-full object-cover [@media(hover:hover)]:group-hover:scale-[1.04] transition-transform [transition-duration:600ms]"
      />
      ...
      {/* Play affordance */}
      <div aria-hidden="true" className="absolute inset-0 opacity-0 [@media(hover:hover)]:group-hover:opacity-100 transition-opacity flex items-center justify-center pointer-events-none">
    ...
    <CardContent className="p-4 space-y-3">
      ...
      <div className="flex items-start justify-between gap-2">
        <h3
          className="font-bold text-[15px] leading-snug text-foreground line-clamp-2 [@media(hover:hover)]:group-hover:text-primary transition-colors cursor-pointer flex-1"
      ...
      <div className="flex items-center gap-2 pt-1">
        ...
        <Button
          ...
          variant="outline"
          className={cn(
            "h-11 w-11 p-0 rounded-xl border-border text-muted-foreground [@media(hover:hover)]:hover:text-destructive [@media(hover:hover)]:hover:border-destructive/40 [@media(hover:hover)]:hover:bg-destructive/5 active:scale-[0.95] transition-all duration-150 focus-visible:ring-2 focus-visible:ring-destructive focus-visible:ring-offset-2",
      ...
      <header className="sticky top-0 z-30 border-b bg-card/95 backdrop-blur-md supports-[backdrop-filter]:bg-card/80 safe-area-top will-change-transform">
        <div className="container mx-auto px-4 py-2 min-h-[52px] flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-xl font-bold text-foreground truncate">{t("page.myCourses")}</h1>
          ...
          <button
            ...
            className="nb-tap shrink-0 inline-flex items-center justify-center h-10 w-10 rounded-full text-foreground/70 [@media(hover:hover)]:hover:text-foreground [@media(hover:hover)]:hover:bg-muted/60 transition-colors duration-150 min-h-[44px] min-w-[44px]"
          >
