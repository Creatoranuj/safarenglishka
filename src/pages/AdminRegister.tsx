...
const AdminRegister = () => {
  ...
  return (
    <div className="min-h-dvh bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg text-center text-white">
          <div className="w-32 h-32 mx-auto mb-8 bg-purple-500/20 rounded-3xl flex items-center justify-center backdrop-blur-sm border border-white/10">
             <img src={logo} alt="Safar English" width={80} height={80} loading="eager" decoding="async" className="h-20 w-20 rounded-xl" />
          </div>
      ...
      <div className="flex-1 flex flex-col justify-center px-8 py-12 lg:px-16">
        <div className="mx-auto w-full max-w-md">
          <Link to="/" className="flex items-center gap-3 mb-8 lg:hidden">
             <img src={logo} alt="Safar English" width={48} height={48} loading="eager" decoding="async" className="h-12 w-12 rounded-xl" />
            <span className="font-bold text-2xl text-white">Safar English</span>
          </Link>
