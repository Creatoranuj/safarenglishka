...
export default function Books() {
  ...
  return (
    <div className="min-h-dvh bg-background">
        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-background/80 backdrop-blur-md border-b border-border safe-area-top">
          <div className="container mx-auto px-4 py-4 flex items-center justify-between">
            <Link to="/" className="flex items-center gap-3">
              <img src={logo} alt="Safar English" width={40} height={40} loading="eager" decoding="async" className="h-10 w-10 rounded-xl" />
      ...
      <main className={isAuthenticated ? 'pt-4 sm:pt-6 pb-12' : 'pt-20 sm:pt-24 pb-12'}>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'Recommended Books - Safar English',
