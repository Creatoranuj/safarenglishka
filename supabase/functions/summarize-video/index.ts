...
- Student ko batao ki better results ke liye lesson ka description available hona chahiye.`;
    ...
    let prompt = "";
    let systemPrompt = `You are Safar Sarthi, the AI learning companion for Safar English coaching platform. You help Indian students preparing for NEET/JEE/Board exams.
...
- Safar English ke YouTube channel ke videos ko priority se summarize karo with proper structure.

${groundingInstruction}`;

    if (mode === "research") {
      systemPrompt = `You are Safar Sarthi, an expert educational researcher for Safar English platform. You do deep conceptual analysis for NEET/JEE/Board exam students.
